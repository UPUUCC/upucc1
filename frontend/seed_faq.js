...
const faqs = [
    ...
    },
    {
        ...
        jawaban: "Pendaftaran dapat dilakukan melalui menu Pendaftaran di website ini saat periode Open Recruitment (Oprec) sedang dibuka. Untuk mengetahui jadwal Oprec, silakan pantau terus informasi terbaru melalui Instagram resmi kami di @upuccofficial.com.",
        order: 5
    }
];
